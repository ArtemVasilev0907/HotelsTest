...
fun Float.toCurrencyString(specialSymbol: String): String {
    return "$this $specialSymbol"
}

fun EditText.afterDateChanged(
...
fun EditText.onFocusChange(onFocusEnd: () -> Unit) {
...
fun EditText.phoneNumberTextChanged(afterTextChanged: (String) -> Unit) {
